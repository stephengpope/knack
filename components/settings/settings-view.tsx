  ...
  return (
    <div className="rounded-lg border border-border bg-card p-5">
      <div className="mb-3.5">
        ...
        {desc && <div className="mt-0.5 text-xs text-ink-soft">{desc}</div>}
      </div>
      {children}
    </div>
  );
    ...
    <FormCard title="Password" desc="Use at least 8 characters.">
      <div className="flex max-w-80 flex-col gap-2.5">
        <div className="grid gap-1.5">
          <Label htmlFor="current" className="text-xs text-ink-soft">
            Current password
          </Label>
          <Input
            id="current"
        ...
        <div className="grid gap-1.5">
          <Label htmlFor="new" className="text-xs text-ink-soft">
            New password
          </Label>
          <Input
            id="new"
...
function AppearanceTab() {
  ...
  return (
    <>
      ...
      <p className="mt-1 text-sm text-ink-soft">Choose how Knack looks.</p>
